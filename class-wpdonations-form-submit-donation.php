	...
	public static function preview() {
		...
		if ( self::$donation_id ) {
			...
			<form method="post" id="donation_preview">
				...
				<input type="submit" name="edit_donation" class="button left" value="<?php _e( '&larr; Edit donation', 'wpdonations' ); ?>" />
				<input type="submit" name="continue" id="donation_preview_submit_button" class="button right" value="<?php echo apply_filters( 'submit_donation_step_preview_submit_text', __( 'Submit Donation &rarr;', 'wpdonations' ) ); ?>" />
			</form>
			<?php
